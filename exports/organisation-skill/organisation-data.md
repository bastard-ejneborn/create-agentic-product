...
Bastard Burgers is a Swedish QSR (burger) chain, ~686 MSEK revenue, Swedish market with Finland + Norway expansion. Structure is functional under the CEO, with six C-level heads.
...
CEO: Simon Wanler  (reports to Board)
  ...
  │     │     ├── District Manager — North: Klas Söderström  (11 restaurants)
  │     │     ├── District Manager — Mid/East: Robert Gustavsson  (17 restaurants)
  │     │     └── District Manager — Mid/West: Brianne Ducharme  (10 restaurants)
  │     ├── Regional Manager South: Ricardo Moses
  │     │     ├── District Manager — Central 1: Mischa Andersson  (11 restaurants)
  ...
  ├── CPO (Chief People Officer): Maja Lundqvist
  │     └── HR Business Partner: Therese Alm
  └── CDTO (Chief Digital & Tech Officer): Johnny Bröms
...
## People Index (primary lookup table)
...
| Johan Gederberg | CXO (Chief Expansion Officer) | Expansion | Simon Wanler | Board | Johan Gederberg |
| Maja Lundqvist | CPO (Chief People Officer) | People / HR | Simon Wanler | Board | Maja Lundqvist |
...
| Malin Lewander | Senior Accountant | Finance | Maria Tornéus | Filip Forsling | Lisa Wanler |
| Marie Dahlberg | Senior Accountant | Finance | Maria Tornéus | Filip Forsling | Lisa Wanler |
| Hanna Lindström | Accountant | Finance | Maria Tornéus | Filip Forsling | Lisa Wanler |
| Nora Blom | Junior Accountant | Finance | Maria Tornéus | Filip Forsling | Lisa Wanler |
| Victor Dahlberg | Junior Accountant | Finance | Maria Tornéus | Filip Forsling | Lisa Wanler |
| Elin Danielsson | Payroll Administrator | Finance | Maria Tornéus | Filip Forsling | Lisa Wanler |
| Johannes Norrblom | Regional Manager North | Operations | Johnny Klippmark | Simon Wanler | Johnny Klippmark |
| Ricardo Moses | Regional Manager South | Operations | Johnny Klippmark | Simon Wanler | Johnny Klippmark |
| Klas Söderström | District Manager — North | Operations | Johannes Norrblom | Johnny Klippmark | Johnny Klippmark |
| Robert Gustavsson | District Manager — Mid/East | Operations | Johannes Norrblom | Johnny Klippmark | Johnny Klippmark |
| Brianne Ducharme | District Manager — Mid/West | Operations | Johannes Norrblom | Johnny Klippmark | Johnny Klippmark |
| Mischa Andersson | District Manager — Central 1 | Operations | Ricardo Moses | Johnny Klippmark | Johnny Klippmark |
...
| Simon Brännström | IT Architect | Digital & Tech / IT | Johnny Bröms | Simon Wanler | Johnny Bröms |
| Kim Axelsson | Point of Sale Architect | Digital & Tech / POS | Johnny Bröms | Simon Wanler | Johnny Bröms |
| Petron Fernandes | Technical Product Owner POS | Digital & Tech / POS | Johnny Bröms | Simon Wanler | Johnny Bröms |
| Roopneet Bhalla | Technical Product Owner POS | Digital & Tech / POS | Johnny Bröms | Simon Wanler | Johnny Bröms |
| Christian Ling | IT Support Team Lead | Digital & Tech / IT | Johnny Bröms | Simon Wanler | Johnny Bröms |
| Robert Beney | Head of Information Security and Compliance | Digital & Tech / InfoSec | Johnny Bröms | Simon Wanler | Johnny Bröms |

## Teams

### Executive Team
> Lead: Simon Wanler (CEO) | Reports to: Board
> Members: CEO + 5 C-level (CFO, COO, CXO, CPO, CDTO)

### Finance
> Lead: Lisa Wanler (CFO) | Reports to: Simon Wanler (CEO)
> Sub-teams: Finance (Filip Forsling), Procurement (Niklas Heinermark)
> Accounting team: 8 people under Maria Tornéus
...
### People / HR
> Lead: Maja Lundqvist (CPO) | Reports to: Simon Wanler (CEO)
> Direct report: Therese Alm (HR Business Partner)

### Digital & Tech (IT)
> Lead: Johnny Bröms (CDTO) | Reports to: Simon Wanler (CEO)
> Headcount: 8 (large relative to company size, reflects ongoing digital transformation)
> Sub-functions: IT Architecture (André, Simon), POS (Kim, Petron, Roopneet), IT Support (Christian), InfoSec (Robert)

## Operations — Restaurant Footprint

### Region North — Johannes Norrblom
- **District North (Klas Söderström)** — 11 restaurants: Luleå, Luleå Shopping, Uppsala, Piteå, Boden, Östersund, Sundsvall, Skellefteå, Gränby, Umeå, Falun
- **District Mid/East (Robert Gustavsson)** — 17 restaurants: Farsta, Liljeholmen, Örebro, Norrköping, Gallerian, Marieberg, St Paul, Eskilstuna, Västerås, Sickla, Alvik, Värmdö, Medborgarplatsen, Gullmarsplan, Sofia, Hammarby Sjöstad, Nyköping
- **District Mid/West (Brianne Ducharme)** — 10 restaurants: Kungälv, Karlstad, Karlstad City, Kalmar, Linköping, Torp, Jönköping, Borås, Skövde, Etage
...
The following are heuristics based on known structure. Verify with the user before asserting as formal policy.

| Scenario | Approver | Notes |
|----------|----------|-------|
| IT support / helpdesk issue | IT Helpdesk (FreshService) | Never route to a named person; always through FreshService |
| IT architecture change | André Ejneborn + Johnny Bröms | CDTO sign-off on significant changes |
| POS change | Kim Axelsson (POS Architect) / Johnny Bröms | |
| InfoSec / compliance | Robert Beney | Escalate to Johnny Bröms if cross-function |
| Restaurant operations issue | District Manager → Regional Manager → COO | Follow the chain |
| Hiring (Tech/Digital) | Johnny Bröms + Maja Lundqvist (People) | |
| Finance / spend | Line manager → Head of Finance (Filip) → CFO (Lisa) | Thresholds not yet documented — ask user |
| Strategic decisions | CEO Simon Wanler (ultimately Board) | |

## Key Person Risks

| Person | Role | Risk If They Leave | Mitigation |
|--------|------|--------------------|-----------|
| André Ejneborn | Senior IT Architect | Owner of most IT systems (42 systems) and integrations (19) | Document ownership transitions; cross-train Simon Brännström |
| Johnny Bröms | CDTO | All of Digital & Tech reports into one person | Strengthen second-line leadership in IT |
| Maria Tornéus | Accounting Manager | 8 accountants report directly to her | Structured deputisation |

## Notes & Special Structures
...
**"Who is Lisa's manager?"** → Disambiguate: Lisa Wanler (CFO)? Reports to Simon Wanler. Malin Lewander? Reports to Maria Tornéus.

**"Has André's manager approved this?"** → André Ejneborn's manager is Johnny Bröms (CDTO). Check the conversation/source for evidence of Johnny's approval; if absent, say so.

**"Who needs to approve an IT architecture change?"** → Per Approval Rules: André Ejneborn + Johnny Bröms.

**"Who is the skip-level for the accounting team?"** → Accounting Manager Maria Tornéus reports to Filip Forsling (Head of Finance); skip-level for accountants is therefore Filip, and the department head is Lisa Wanler (CFO).
