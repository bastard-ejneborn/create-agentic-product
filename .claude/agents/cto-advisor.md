...
model: sonnet
skills: company-strategy, budget-tracker, project-portfolio, risk-register, vendor-manager, team-structure, tech-radar, decision-framework, stakeholder-briefing, meeting-prep
---
