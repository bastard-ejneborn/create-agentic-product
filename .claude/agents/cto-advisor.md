...
model: sonnet
skills: company-strategy, company-policies, budget-tracker, project-portfolio, risk-register, vendor-manager, team-structure, tech-radar, freshservice, simphony, decision-framework, stakeholder-briefing, meeting-prep
---
